...
@section('breadcrumbs')
    ...
    <li><a href="/admin/review/create">Create</a></li>
@stop

@section('title')
    Create new review ( WHAT OUR CLIENTS ARE SAYING )
@stop
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <div class="form-group">
                    ...
                    <input  class="form-control" type="text" name="client_position" id="client_position" value="{{ old('client_position') }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="client_text" id="client_text">{{ old('client_text') }}</textarea>
                </div>
            </div>
        </div>
